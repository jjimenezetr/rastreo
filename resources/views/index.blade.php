...
<div id="owl-demo" class="owl-carousel owl-theme">
    <div class="item img-fluid"><img src="{{ asset('images/slide1.jpg') }}" alt="slider-image"/>
    </div>
    <div class="item img-fluid"><img src="{{ asset('images/slider4.jpg') }}" alt="slider-image">
    </div>
    <div class="item img-fluid"><img src="{{ asset('images/slide3.jpg') }}" alt="slider-image">
    </div>
</div>
<!-- //Carousel End -->
@stop
...
<div class="container">
        ...
        <div class="container bg-border wow pulse" data-wow-duration="2.5s">
            <div class="row">
                <div class="col-md-7 col-sm-12 col-12 col-lg-8">
                    <h1 class="purchae-hed mt-3">Digitalización y Tecnologías</h1></div>
                <div class="col-md-5 col-sm-12 col-12 col-lg-4"><a href="#" class="btn purchase-styl float-lg-right">Ingresar</a></div>
            </div>
        </div>
    </section>
    ...
    <div class="row">
        ...
        <div class="col-12 text-center my-3">
            <h3 class="border-primary"><span class="heading_border bg-primary mx-auto">Nuestros Servicios</span></h3></div>
        <div class="col-sm-6 col-md-6 col-lg-3 wow bounceInLeft" data-wow-duration="3.5s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="success text-center">Diseño Web</h3>
                    <p>La evolución no es organizada y la disrupción no da treguas. Pero controlando ese caos aparente es posible elaborar enfoques exitosos, reducir los riesgos y obtener mayores beneficios del cambio tecnológico.</p>
                    <div class="text-right primary"><a href="#">Leer más</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-6  col-lg-3 col-12 wow bounceInDown" data-wow-duration="3s" data-wow-delay="0.4s">
            ...
            <div class="box">
                ...
                <div class="info">
                    <h3 class="primary text-center">DevOps</h3>
                    <p>Aplicamos las prácticas modernas de ingeniería de software a través de la automatización y monitoreo del ciclo desarrollo-operación con técnicas de integración continua, pruebas automatizadas, despliegue por contenedores, implantación y administración de la infraestructura, agilizando la liberación de nuevas soluciones alineadas a los objetivos de negocios de la organización.</p>
                    <div class="text-right primary"><a href="#">Leer más</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6  col-lg-3 col-12 wow bounceInUp" data-wow-duration="3s" data-wow-delay="0.8s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="warning text-center">Especializandonos</h3>
                    <p>Somos un equipo altamente motivado, que se especializa en tecnologías claves y con décadas de experiencia en transformar los cambios tecnológicos en oportunidades concretas de negocio para nuestros clientes.</p>
                    <div class="text-right primary"><a href="#">Leer más</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 col-12  wow bounceInRight" data-wow-duration="5s" data-wow-delay="1.2s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="yellow text-center">Colaborando</h3>
                    <p>La innovación es de por sí una actividad participativa que se apoya cada vez más en modelos colaborativos, y en particular en comunidades de desarrolladores Open Source.</p>
                    <div class="text-right primary"><a href="#">Leer más</a>
                    </div>
                </div>
            </div>
