    ...
    <div class="container advfeatures">
        ...
        <div class="row">
            <div class="col-md-6 my-2">
                <div class="card panel-primary">
                    <div class="card-heading">
                        <h4 class="card-title">Blue Header Card</h4>
            ...
            <div class="col-md-6 my-2">
                <div class="card panel-success">
                    <div class="card-heading">
                        <h4 class="card-title">Green Header Card</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 my-2">
                <div class="card panel-danger">
                    <div class="card-heading">
                        <h4 class="card-title">Red Header Card</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
            ...
            <div class="col-md-6 my-2">
                <div class="card panel-warning">
                    <div class="card-heading">
                        <h4 class="card-title">Orange Header Card</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pop d-none d-sm-block mb-2">
                <h3>Popover</h3>
                    <button type="button" class="btn btn-secondary" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Popover on left">Popover left</button>
                    <button type="button" class="btn btn-primary" title="Popover title" data-container="body" data-toggle="popover" data-placement="top" data-content="Popover on top">Popover top</button>
                    ...
                    <button type="button" class="btn btn-warning" title="Popover title" data-container="body" data-toggle="popover" data-placement="right" data-content=" popover on right">Popover right</button>
