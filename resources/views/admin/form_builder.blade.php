...
@section('header_styles')
    ...
    <link rel="apple-touch-icon" href="{{ asset('vendors/bootstrap-form-builder/images/apple-touch-icon.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('vendors/bootstrap-form-builder/images/apple-touch-icon-72x72.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('vendors/bootstrap-form-builder/images/apple-touch-icon-114x114.png') }}">
...
<script data-main="{{ asset('vendors/bootstrap-form-builder/assets/js/main.js') }}" src="{{ asset('js/pages/require.js') }}" ></script>
{{--<script data-main="{{ asset('vendors/bootstrap-form-builder/js/main.js') }}" src="https://rawgithub.com/jrburke/requirejs/master/require.js"></script>--}}
<script>
