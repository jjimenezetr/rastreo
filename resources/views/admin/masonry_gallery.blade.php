                    ...
                    <div class="row" id="slim">
                            ...
                            <div class="ml-auto">
                                <div class="col-12 mb-10 filter-button-group">
                                    <button type="button" id="filter-all" data-filter=".all" class="btn btn-responsive btn-info btn-sm">All</button>
                                    <button type="button" id="filter-studio" data-filter=".studio" class="btn btn-responsive btn-primary btn-sm">Studio</button>
                                    <button type="button" id="filter-landscape" data-filter=".landscape" class="btn btn-responsive btn-success btn-sm">Landscape</button>
                                </div>
                            </div>
                        </div>
