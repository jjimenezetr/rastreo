...
<section class="content-header">
            ...
            <!-- Main content -->
            <section class="content paddingleft_right15 my-3" id="invoice-stmt">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card panel-success">
                            <div class="card-heading">
                                <h3 class="card-title"><i class="livicon" data-name="tablet" data-size="16" data-loop="true" data-c="#fff" data-hc="#fff"></i> Invoice from <bold>JOSH</bold></h3>
                            ...
                            <div class="card-body" style="border:1px solid #ccc;padding:0;margin:0;">
                                ...
                                <div style="background-color: #eee;padding:15px;" id="footer-bg">
                                    ...
                                    <div style="margin:10px 20px;text-align:center;" class="btn-section">
                                        ...
                                        <button type="button" class="btn btn-responsive btn_marTop button-alignment btn-default default_voice"
                                                data-toggle="button">
                                            <a style="color:#333;">
