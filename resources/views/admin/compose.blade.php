                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="compose row">
                            <label class="col-2 d-none d-sm-inline-block d-md-inline-block d-lg-inline-block" for="to1">To:</label>
                            <input type="email" name="email" class="col-9" id="to1" placeholder="Email id"
                                   tabindex="1" required>
                            <div class="clear"></div>
                            <label class="col-2 d-none d-sm-inline-block d-md-inline-block d-lg-inline-block" for="to">Subject:</label>
