...
@section('header_styles')
    ...
    <link href="{{ asset('css/pages/sweetalert.css') }}" rel="stylesheet" type="text/css"/>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/sweetalert/js/sweetalert.min.js') }}" type="text/javascript"></script>
