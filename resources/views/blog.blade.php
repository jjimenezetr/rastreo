                ...
                <div class="ml-auto col-md-4 col-lg-4 col-12">
                    ...
                    <div class="the-box recent">
                        ...
                        <!--<ul class="media-list media-xs media-dotted">-->
                            <!--<li class="media">-->
                                <!--<a class="float-left" href="#">-->
                                    <!--<img src="{{ asset('images/authors/avatar.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">-->
                                <!--</a>-->
                        ...
                        <div class="media">
                            ...
                            <div class="media">
                                <a class="float-left" href="#">
                                <img src="{{ asset('images/authors/avatar1.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">
                                </a>
                                <div class="media-body ml-3">
                                    <h4 class="media-heading primary">
                            ...
                            <div class="media">
                                <a class="float-left" href="#">
                                <img src="{{ asset('images/authors/avatar5.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">
                                </a>
                                <div class="media-body ml-3">
                                    <h4 class="media-heading primary">
