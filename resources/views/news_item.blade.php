        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-4 col-full-width-left">
                ...
                <div class="the-box  no-margin more-padding martop3 wow slideInDown" data-wow-duration="3.5s">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar.jpg') }}" class="img-fluid img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar1.jpg') }}" class="img-fluid img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar2.jpg') }}" class="img-fluid img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                        <div class="col-3">
                            <p>
                                <a href="#">
                                    <img src="{{ asset('images/authors/avatar3.jpg') }}" class="img-fluid img-circle" alt="riot">
                                </a>
                            </p>
                        </div>
                        <!-- /.col-xs-3 -->
                ...
                <div class="the-box wow slideInRight" data-wow-duration="1.5s">
                    ...
                    <ul class="media-list media_list1">
