                        ...
                        <ul class="padding_left0">
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar1.jpg') }}" class="rounded-circle img-fluid pull-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar4.jpg') }}" class="rounded-circle img-fluid pull-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img src="{{ asset('images/authors/avatar5.jpg') }}" class="rounded-circle img-fluid pull-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
